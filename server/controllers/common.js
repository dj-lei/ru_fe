 ...
 * Knowledge Graph
 */
router.get(['/tools', '/tools/*'], async (req, res, next) => {
  ...
  if (isPage) {
    ...
    try {
      ...
      page = {
        id: 5,
        path: 'home/DJ',
        hash: 'cd442acd7c2b44c583e49ba0e3129a0af32857e1',
        title: 'RBS',
        description: 'DJ',
        isPrivate: false,
        isPublished: true,
        ...
        publishStartDate: '',
        publishEndDate: '',
        content: '# Radio Application Architecture Description\n' +
          'The document discusses the Modularized Radio Application reference architecture goals and presents it the in several views: functional, concurrency, deployment and development view. It also briefly describes the Radio Application’s role and placement in the Base Station system.\n' +
          '## 1 Radio application in the RBS\n' +
          'The RBS HW may be schematically depicted as the assembly of four sub-systems:\n' +
          '![2.png](/2.png)\n' +
          'On the downlink path, the Digital Subsystem [DU](/home/DU) receives information through the Transport Network interface and uses Baseband signal processing to encode the data as IQ modulated digital data to meet the requirements of the antenna interface (AI). The IQ digital data is then sent to the Radio Subsystem (RU) through the CPRI interface. In the RU, the IQ data is used to modulate the downlink carrier to an RF signal, which is filtered, amplified, and forwarded, to the antenna, where it is transmitted through the air interface.',
        render: '<h1 class="toc-header" id="radio-application-architecture-description"><a href="#radio-application-architecture-description" class="toc-anchor">¶</a> Radio Application Architecture Description</h1><div>\n' +
          '</div><p>The document discusses the Modularized Radio Application reference architecture goals and presents it the in several views: functional, concurrency, deployment and development view. It also briefly describes the Radio Application’s role and placement in the Base Station system.</p><div>\n' +
          '</div><h2 class="toc-header" id="h-1-radio-application-in-the-rbs"><a href="#h-1-radio-application-in-the-rbs" class="toc-anchor">¶</a> 1 Radio application in the RBS</h2><div>\n' +
          '</div><p>The RBS HW may be schematically depicted as the assembly of four sub-systems:<br>\n' +
          '<img alt="2.png" src="/2.png"><br>\n' +
          'On the downlink path, the Digital Subsystem <a class="is-internal-link is-valid-page" href="/home/DU">DU</a> receives information through the Transport Network interface and uses Baseband signal processing to encode the data as IQ modulated digital data to meet the requirements of the antenna interface (AI). The IQ digital data is then sent to the Radio Subsystem (RU) through the CPRI interface. In the RU, the IQ data is used to modulate the downlink carrier to an RF signal, which is filtered, amplified, and forwarded, to the antenna, where it is transmitted through the air interface.</p><div>\n' +
          '</div>',
        toc: '[{"title":"Radio Application Architecture Description","anchor":"#radio-application-architecture-description","children":[{"title":"1 Radio application in the RBS","anchor":"#h-1-radio-application-in-the-rbs","children":[]}]}]',
        contentType: 'markdown',
        createdAt: '2020-10-29T07:37:13.306Z',
        updatedAt: '2020-10-29T10:03:16.419Z',
        editorKey: 'markdown',
        localeCode: 'en',
        authorId: 1,
        creatorId: 1,
        ...
        authorEmail: 'm18349125880@gmail.com',
        creatorName: 'Administrator',
        creatorEmail: 'm18349125880@gmail.com',
        tags: [ { tag: 'dj', title: 'dj' } ]
      }
